...
@objc class Callbacks {
  ...
  func namedArguments(_ input: (_ f1: Float, _ f2: Float, _ d1: Double, _ d2: Double) -> ()) {}
  func blockTakesNamedBlock(_ input: (_ block: () -> ()) -> ()) {}
  ...
  func functionPointersWithName(_ input: @convention(c) (_ value: Int) -> Int)
